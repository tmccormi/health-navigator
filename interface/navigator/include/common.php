...
function _base_url() {
    return $GLOBALS['webroot'] . '/interface/navigator';
}
...
function interface_url() {
    return $GLOBALS['webroot'] . '/interface';
}
...
function js_src( $file ) {
    return _base_url() . '/www/js/' . $file;
}

function css_src( $file ) {
    return _base_url() . '/www/css/' . $file;
}
