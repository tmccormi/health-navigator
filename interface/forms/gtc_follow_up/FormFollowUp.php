...
class FormFollowUp extends Mi2_Ui_AbstractForm
{
    public function init()
    {
        $this->setName( 'gtc_follow_up' );	
	
        $elem = new Zend_Form_Element_Checkbox( 'providerConfirm' );
        $elem->setLabel( 'Did provider see the patient?' )
            ->setRequired();
    ...
    {
        return $GLOBALS['rootdir']."/forms/gtc_follow_up";
    }
