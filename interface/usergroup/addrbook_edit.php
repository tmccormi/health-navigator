 ...
 if ($option_abook_type == 3) {
  ...
  if ($userid) {
   ...
   $query = "UPDATE users SET " .
    ...
    "provider_slots_pledged = " . invalue('form_provider_slots_pledged') . ", " .
    "provider_slots_used = " . invalue('form_provider_slots_used') . ", " .
   ...
   $userid = sqlInsert("INSERT INTO users ( " .
    ...
    "phone, phonew1, phonew2, phonecell, fax, notes, abook_type, provider_slots_pledged, provider_slots_used  " .
    ") VALUES ( "                        .
    "'', "                               . // username
    "'', "                               . // password
    "0, "                                . // authorized
    ...
    invalue('provider_slots_pledged') . ", " .
    invalue('provider_slots_used') . " " .
   ")");
...
?>
 ...
 <tr>
  <td nowrap width="1%"><b><?php echo xlt('Slots Pledged'); ?>:</b></td>
  <td>
   <input type='text' name='form_provider_slots_pledged' size='10' maxlength='50'
    value='<?php echo attr($row['provider_slots_pledged']); ?>' class='inputtext' />
  &nbsp;<b><?php echo xlt('Slots Used'); ?></b>:
   <input type='text' name='form_provider_slots_used' size='10' maxlength='50'
    value='<?php echo attr($row['provider_slots_used']); ?>' class='inputtext' />
  &nbsp;<b><?php echo xlt('Slots Remaining'); ?></b>:
    <?php $remaining = max(0,$row['provider_slots_pledged']-$row['provider_slots_used'])?>
